...
var getAll = (callback) => {
    var sql = "SELECT * FROM books ORDER BY user_id DESC, book_id ASC";
...
var getIssuedBooks = (id, callback) => {
    var sql = "SELECT * FROM books WHERE NOT user_id IS NULL";
    db.executeQuery(sql, null, function(result) {
        callback(result);
    });
};
...
var getUnborrowedBooks = (callback) => {
    var sql = "SELECT * FROM books WHERE user_id IS NULL";
    db.executeQuery(sql, null, function(result) {
        callback(result);
    });
};
...
var deleteRequestedBooks = (request_id,callback) => {
    var sql = "DELETE FROM books_request WHERE request_id = ?";
    db.executeQuery(sql,[request_id],function(result) {
        callback(result);
    });
};
